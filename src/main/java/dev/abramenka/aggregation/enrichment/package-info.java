 ...
 * {@code @Component} implementing {@code AggregationPart} (typically through
 * {@code WorkflowAggregationPart}). The component {@code name()} is the public {@code include}
 * value. Declare {@code dependencies()} when the enrichment needs data produced by another part.
 *
