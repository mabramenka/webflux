...
class HttpServiceExternalClientsTest {
    ...
    void fetch_sendsExpectedRequest(WebClientCase clientCase) {
        AtomicReference<@Nullable ClientRequest> capturedRequest = new AtomicReference<@Nullable ClientRequest>();
    ...
    @Test
    void resolver_rejectsNullClientRequestContext() {
        MethodParameter parameter = mock(MethodParameter.class);
        doReturn(ClientRequestContext.class).when(parameter).getParameterType();
        ClientRequestContextHttpServiceArgumentResolver resolver =
                new ClientRequestContextHttpServiceArgumentResolver();
    ...
    private static WebClient webClient(
            AtomicReference<@Nullable ClientRequest> capturedRequest, ClientResponse response) {
    ...
    private static WebClient webClient(ClientResponse response) {
        return webClient(new AtomicReference<@Nullable ClientRequest>(), response);
    }
