...
import com.example.aggregation.application.enrichment.OwnersEnrichment;
import com.example.aggregation.application.enrichment.PricingEnrichment;
import com.example.aggregation.application.enrichment.ProfileEnrichment;
...
class AggregateServiceTest {
    ...
    @Mock
    private WebClientMainClient mainClient;
    @Mock
    private WebClientProfileClient profileClient;
    @Mock
    private WebClientPricingClient pricingClient;
    @Mock
    ...
    void setUp() {
        aggregateService = new AggregateService(
            mainClient,
            List.of(new ProfileEnrichment(profileClient), new PricingEnrichment(pricingClient), new OwnersEnrichment(ownersClient))
        );
    }
    ...
    @Test
    void aggregate_fetchesOnlyRequestedEnrichments() {
        ObjectNode inboundRequest = objectMapper.createObjectNode()
            .put("customerId", "cust-1")
            .put("market", "US");
    ...
    @Test
    void aggregate_rejectsUnknownRequestedEnrichmentsBeforeCallingMain() {
        ObjectNode inboundRequest = objectMapper.createObjectNode()
            .put("customerId", "cust-1");
    ...
    @Test
    void aggregate_rejectsNonStringRequestedEnrichmentsBeforeCallingMain() {
        ObjectNode inboundRequest = objectMapper.createObjectNode()
            .put("customerId", "cust-1");
